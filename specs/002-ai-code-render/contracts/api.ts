/**
 * MoltUI Public API Contract
 *
 * This file defines the public interfaces for MoltUI.
...
export interface MoltUI {
   ...
   *
   * @param description - Natural language description of desired interface
   ...
   * if (result.success) {
   *   result.interface.on('box-1', 'click', (e) => console.log('Clicked!'));
   * }
   * ```
   */
 ...
 * ```
 */
export declare function createMoltUI(config: MoltUIConfig): MoltUI;
